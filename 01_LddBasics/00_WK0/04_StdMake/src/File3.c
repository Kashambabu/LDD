...
#define PROC_NAME "FirstDriverFile2"
...
unsigned int MyReadCounter2 =0u;

/* Executed when a user opens /proc/file_context_demo */
int my_proc_open2(struct inode *inode, struct file *file)
{
...
int my_proc_release2(struct inode *inode, struct file *file)
{
...
ssize_t	MyReadFunc2(struct file *fp, char __user *UserData, size_t Size, loff_t * Offset)
{
    char msg[] = "DummyData\n";
